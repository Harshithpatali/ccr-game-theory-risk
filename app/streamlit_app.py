...
# ============================================================================
#  Global styling — clean, professional, no animations
# ============================================================================
st.markdown(
    """
    <style>
      ...
      .block-container {
        padding-top: 1.4rem; padding-bottom: 2.5rem; max-width: 1550px;
      }

      /* hero banner — solid, no animation */
      .ccr-hero {
      ...
      .ccr-hero p {
        color: #c7d2fe; margin: 6px 0 0; font-size: .86rem;
      }

      /* KPI cards — flat, subtle border, no hover lift */
      ...
      div[data-testid="stMetricValue"] {
        font-size: 1.45rem; font-weight: 700; color: var(--ccr-ink);
      }
      ...
      /* interpretation panel — soft decision card, static */
      .ccr-interpretation {
